...
namespace WTCJ.BLL
{
	...
	{
		private readonly WTCJ.DAL.Area dal=new WTCJ.DAL.Area();
		public Area()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.Area> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.Area> DataTableToList(DataTable dt)
		{
			List<WTCJ.Model.Area> modelList = new List<WTCJ.Model.Area>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WTCJ.Model.Area model;
