...
namespace WTCJ.BLL
{
	...
	{
		private readonly WTCJ.DAL.Common_Data dal=new WTCJ.DAL.Common_Data();
		public Common_Data()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.Common_Data> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.Common_Data> DataTableToList(DataTable dt)
		{
			List<WTCJ.Model.Common_Data> modelList = new List<WTCJ.Model.Common_Data>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WTCJ.Model.Common_Data model;
