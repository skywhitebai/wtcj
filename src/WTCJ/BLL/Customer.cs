...
namespace WTCJ.BLL
{
	...
	{
		private readonly WTCJ.DAL.Customer dal=new WTCJ.DAL.Customer();
		public Customer()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.Customer> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.Customer> DataTableToList(DataTable dt)
		{
			List<WTCJ.Model.Customer> modelList = new List<WTCJ.Model.Customer>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WTCJ.Model.Customer model;
