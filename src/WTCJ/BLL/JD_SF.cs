...
namespace WTCJ.BLL
{
	...
	{
		private readonly WTCJ.DAL.JD_SF dal=new WTCJ.DAL.JD_SF();
		public JD_SF()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 带事务的增加一条数据
		/// </summary>
		public bool Add(System.Data.SqlClient.SqlTransaction tran,WTCJ.Model.JD_SF model)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.JD_SF> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<WTCJ.Model.JD_SF> DataTableToList(DataTable dt)
		{
			List<WTCJ.Model.JD_SF> modelList = new List<WTCJ.Model.JD_SF>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				WTCJ.Model.JD_SF model;
