...
namespace WTCJ.DBUtility
{
    /// <summary>
    /// 数据访问抽象基础类
    /// Copyright (C) 2015-2015 By BaiXuePing 
    /// </summary>
    ...
    {        //数据库连接字符串(web.config来配置)，多数据库可使用DbHelperSQLP来实现.
        ...
        public static bool Exists(string strSql, SqlTransaction tran, params SqlParameter[] cmdParms)
        {
            object obj = GetSingle(strSql, tran, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, SqlTransaction tran)
        {
            DataSet ds = new DataSet();
            try
            {
                SqlCommand cmd = new SqlCommand(SQLString, tran.Connection, tran);
        ...
        ///执行查找语句，返回datatable对象
        ///</summary>
        public static DataTable GetDataTable(string strSQL, SqlTransaction tran)
        {
            DataTable dt = new DataTable();
            try
            {
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string SQLString, SqlTransaction tran, params SqlParameter[] cmdParms)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                try
        ...
        /// <param name="SQLString">计算查询结果语句</param>
        /// <returns>查询结果（object）</returns>
        public static object GetSingle(string SQLString, SqlTransaction tran, params SqlParameter[] cmdParms)
        {
            using (SqlCommand cmd = new SqlCommand())
            {
                try
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, SqlTransaction tran, params SqlParameter[] cmdParms)
        {
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, tran.Connection, tran, SQLString, cmdParms);
            using (SqlDataAdapter da = new SqlDataAdapter(cmd))
        ...
        public static DataTable PageData(string TblName, string Fields, string OrderField, string SqlWhere, int PageSize, int pageIndex, out int TotalPage)
        {
